...
//타임오버
//이유 : 정확한 뱡항 설정 실패 ->펜을 쓰자... ㅠㅡㅠ


//추가 스킬들
//한쪽 방향으로 시작해서 하는 그런 시물레이션은 굳이 queue나 deque pop, push등을 이용하지 않고 while 루프문 이용
//이 문제에서 처음 시작할 때 "이동하고 나서" 아무것도 부딪치지 않으면 탐색할 이유가 극히 적어짐